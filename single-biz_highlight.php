<?php
/**
 * Template Name: Biz Highlight Single
 */
...
$args = array( 'post_type' => 'biz_highlight', 'posts_per_page' => 1 );
...
$ln = get_post_meta($post->ID, "ln", true);
	...
	<div class="row">
		<section class="large-12 columns">
			<figure class="bizMainPic">
				...
				<figcaption>
					<span class="headline">Biz Spotlight</span>				
					<?php $date = date("F Y"); ?>
